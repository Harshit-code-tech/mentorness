...
#%%
# Load the dataset
df = pd.read_csv('/internship/mentorness/machine learning/ml_2/FastagFraudDetection.csv')
#%% md
# # 1. Data Exploration
#%% md
...
# Save the pipeline
import joblib
joblib.dump(pipeline, '/internship/mentorness/machine learning/ml_2/fastag_fraud_detection_pipeline.pkl')
